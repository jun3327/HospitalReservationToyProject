...
public class ReservationService {
    ...
    public Long createOne(Long hospitalId, Long departmentId, Long doctorId, Long patientId) {
        ...
        //중복 예약 방지 로직
        validateDuplicateReservation(doctorId, patientId);
    ...
    public void validateDuplicateReservation(Long doctorId, Long patientId) {
        List<Reservation> duplicateReservation = reservationRepository.findDuplicateReservation(doctorId, patientId, ReserveStatus.RESERVE);
